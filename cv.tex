...
\subsection*{Journal articles (selected, published/accepted)}
\begin{enumerate}
  ...
  \item Guo H., He K. \emph{Scenario-Conditioned Actual Meteorological Years (sAMY): A Stochastic Weather Generator Using Multi-Decadal Observations.} Energy and Buildings, accepted 2026. \textcolor{gray}{[Synthetic weather, scenario-conditioned]}
